...
{
    public partial class AlazharPlan2 : UserControl
    {
        private int _choose;
        public AlazharPlan2()
        {
        ...
        private void AlazharPlan2_Load(object sender, EventArgs e)
        {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            string arabicText = Digitts(inputText);
        ...
        private void button5_Click_1(object sender, EventArgs e)
        {
            ...
            {
                ActualPlan2 newForm = new ActualPlan2(textBox1.Text, textBox2.Text, textBox4.Text, textBox5.Text, _choose);
                newForm.Show();
                this.Hide();
            }
        }
